...
cat("\nPure L-moment estimates (para.jkss, Shin et al. 2025b method):\n")
cat("  mu0 =", round(result$para.jkss[1], 4), "\n")
cat("  mu1 =", round(result$para.jkss[2], 4), "\n")
cat("  sigma0 =", round(result$para.jkss[3], 4), "\n")
cat("  sigma1 =", round(result$para.jkss[4], 4), "\n")
cat("  xi =", round(result$para.jkss[5], 4), "\n")
